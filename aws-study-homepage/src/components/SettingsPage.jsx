      ...
      <div className="settings-section">
        ...
        <div className="avatar-section-content">
          ...
          <div className="avatar-tab-content">
            {avatarTab === 'emoji' && (
              <>
                ...
                <div style={{ marginTop: 16 }}>
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: 8 }}>Background Color</p>
            ...
            {avatarTab === 'pattern' && (
              <div className="pattern-area">
                ...
                <div style={{ marginTop: 8 }}>
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: 8 }}>Base Color</p>
                  <div className="color-swatches">
                    {COLOR_OPTIONS.map((color) => (
                      <button
                        key={color}
            ...
            {avatarTab === 'color' && (
              <div>
                <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: 12, textAlign: 'center' }}>
