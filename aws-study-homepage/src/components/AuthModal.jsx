...
import { SecurityIcon, CheckIcon, ArrowRightIcon, ExternalLinkIcon } from './Icons';
      ...
      <div className="auth-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="auth-header">
          ...
          <p className="auth-subtitle">
            {mode === 'login' 
              ? 'Sign in to track your AWS certification progress' 
              : 'Join AWS Study Hub to save your progress'}
          </p>
        </div>
        ...
        <div className="auth-benefits">
          ...
          <ul>
            ...
            <li><CheckIcon size={14} /> Never lose your study streak</li>
          </ul>
        </div>
      </div>
    </div>
